...
<body>
    ...
    <main role="main" class="container md">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <img src="<?php echo $row['thumb_img']; ?>"
                                                    alt="<?php echo $row['id']; ?>" width="500" class="img-fluid"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-inline">
                                                    <button type="submit" name="id" class="btn btn-danger"
                                                        value="<?php echo $row['id']; ?>">Thêm vào giỏ</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
      ...
      ?>
        ...
        <button type="submit" id="myBtn" data-toggle="modal" data-target="#paymentModal" class="btn btn-success">Thanh
            toán</button>
        ...
        <div class="modal fade" id="paymentModal" tabindex="-1" role="dialog" aria-labelledby="paymentModal"
          ...
          ?>
                                <tr>
                                    <th class="text-right" colspan="5">Tổng tiền:
                                        <?php echo number_format($total, 0); ?>đ</th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
